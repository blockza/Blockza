...
shared ({ caller }) actor class Dip721NFT() = Self {
  ...
  custodians := List.push(Principal.fromText("xjhck-5nmcl-lhpaf-b7muq-gbqq3-y72gv-yttuy-uqskd-7fqtc-yhlwc-gae"), custodians);
  custodians := List.push(Principal.fromText("l4iip-scfk2-go3r4-n62dk-p7wsk-hye7i-fj2c7-uz3me-ypss7-tqyyq-bqe"), custodians);
  stable var logo : Types.LogoResult = {
    logo_type = "img";
    data = "";
  };
  stable var name : Text = "NFT24STUDIO ARTICLE";
  stable var symbol : Text = "N24";
